...
const DATE_IDEAS: Array<{
  ...
  // Doma
  { title: "Kuhanje novega recepta", titleEn: "Cook a new recipe", titleHr: "Kuhanje novog recepta", description: "Izbrajta si recept, ki ga še nista poskusila, in ga skupaj pripravita.", descriptionEn: "Pick a recipe you haven't tried yet and make it together.", descriptionHr: "Izaberite recept koji još niste probali i skuhajte ga zajedno.", category: "doma", cost: "eur", duration: "1h" },
  { title: "Virtualni obisk muzeja", titleEn: "Virtual museum visit", titleHr: "Virtualni posjet muzeju", description: "Odpri Google Arts & Culture in izbrajta muzej, ki bi ga rada obiskala — od Louvra do Van Gogha.", descriptionEn: "Open Google Arts & Culture and pick a museum you'd like to visit — from the Louvre to Van Gogh.", descriptionHr: "Otvorite Google Arts & Culture i izaberite muzej koji biste željeli posjetiti — od Louvrea do Van Gogha.", category: "doma", cost: "brezplacno", duration: "1h", website: "https://artsandculture.google.com" },
  { title: "Ustvarjanje skupnega seznama želja", titleEn: "Create a shared bucket list", titleHr: "Izrada zajedničkog popisa želja", description: "Zapišita si stvari, ki bi ju rada skupaj doživela.", descriptionEn: "Write down things you'd like to experience together.", descriptionHr: "Zapišite stvari koje biste željeli zajedno doživjeti.", category: "doma", cost: "brezplacno", duration: "30min" },
  { title: "Filmski maraton", titleEn: "Movie marathon", titleHr: "Filmski maraton", description: "Izberita trilogijo ali serijo filmov in preživita večer z njimi.", descriptionEn: "Pick a trilogy or film series and spend the evening watching it.", descriptionHr: "Izaberite trilogiju ili seriju filmova i provedite večer uz njih.", category: "doma", cost: "brezplacno", duration: "2h+" },
  { title: "Ples v dnevni sobi", titleEn: "Living room dance", titleHr: "Ples u dnevnoj sobi", description: "Predvajajta najljubšo glasbo in zaplešita, kot da vaju nihče ne gleda.", descriptionEn: "Play your favorite music and dance like nobody's watching.", descriptionHr: "Pustite najdražu glazbu i zaplešite kao da vas nitko ne gleda.", category: "doma", cost: "brezplacno", duration: "30min" },
  { title: "Spa večer doma", titleEn: "Home spa night", titleHr: "Spa večer kod kuće", description: "Pripravita si domač spa večer z maskami za obraz in sproščujočo glasbo.", descriptionEn: "Set up a home spa evening with face masks and relaxing music.", descriptionHr: "Priredite domaći spa večer s maskama za lice i opuštajućom glazbom.", category: "doma", cost: "eur", duration: "1h" },
  { title: "Igranje starih videoiger", titleEn: "Play old video games", titleHr: "Igranje starih videoigara", description: "Obudita spomine z igranjem iger iz otroštva.", descriptionEn: "Relive memories by playing games from your childhood.", descriptionHr: "Prisjetite se uspomena igrajući igre iz djetinjstva.", category: "doma", cost: "brezplacno", duration: "1h" },
  // Na prostem
  { title: "Sprehod po Tivoliju", titleEn: "Walk through Tivoli Park", titleHr: "Šetnja Tivolijem", description: "Sproščen sprehod po največjem ljubljanskem parku.", descriptionEn: "A relaxed walk through Ljubljana's largest park.", descriptionHr: "Opuštena šetnja najvećim ljubljanskim parkom.", category: "na-prostem", cost: "brezplacno", duration: "1h", locationType: "parki", city: "Ljubljana", lat: 46.0569, lng: 14.4885 },
  { title: "Kolesarjenje po Ljubljani", titleEn: "Cycling around Ljubljana", titleHr: "Biciklizam po Ljubljani", description: "Raziščita mesto na dveh kolesih.", descriptionEn: "Explore the city on two wheels.", descriptionHr: "Istražite grad na dva kotača.", category: "na-prostem", cost: "brezplacno", duration: "2h", locationType: "rekreacijski-centri", city: "Ljubljana", lat: 46.0511, lng: 14.5051 },
  { title: "Piknik na Rožniku", titleEn: "Picnic at Rožnik", titleHr: "Piknik na Rožniku", description: "Vzemita odejo in malico ter uživajta v razgledu na mesto.", descriptionEn: "Bring a blanket and snacks and enjoy the view over the city.", descriptionHr: "Ponesite deku i užinu te uživajte u pogledu na grad.", category: "na-prostem", cost: "brezplacno", duration: "2h+", locationType: "naravni-kraji", city: "Ljubljana", lat: 46.065, lng: 14.4687 },
  { title: "Vrtnarjenje", titleEn: "Gardening", titleHr: "Vrtlarenje", description: "Posadita nekaj skupaj, za kar bosta lahko skupaj skrbela.", descriptionEn: "Plant something together that you can both take care of.", descriptionHr: "Posadite nešto zajedno o čemu ćete se zajedno brinuti.", category: "na-prostem", cost: "eur", duration: "1h" },
  { title: "Pohod na Šmarno goro", titleEn: "Hike up Šmarna gora", titleHr: "Pohod na Šmarnu goru", description: "Priljubljena ljubljanska razgledna točka, primerna za par ur pohoda.", descriptionEn: "A popular Ljubljana viewpoint, good for a couple hours of hiking.", descriptionHr: "Omiljena ljubljanska vidikovac, prikladna za par sati planinarenja.", category: "na-prostem", cost: "brezplacno", duration: "2h+", locationType: "naravni-kraji", city: "Ljubljana", lat: 46.1225, lng: 14.4557 },
  // Kulturno
  { title: "Obisk Narodne galerije", titleEn: "Visit the National Gallery", titleHr: "Posjet Narodnoj galeriji", description: "Ogled slovenske umetnostne zgodovine v središču mesta.", descriptionEn: "See Slovenian art history in the heart of the city.", descriptionHr: "Razgledajte slovensku povijest umjetnosti u središtu grada.", category: "kulturno", cost: "eur", duration: "2h", locationType: "galerije", city: "Ljubljana", address: "Prešernova cesta 24", lat: 46.0508, lng: 14.4989 },
  { title: "Obisk gledališča", titleEn: "Go to the theatre", titleHr: "Posjet kazalištu", description: "Preverita repertoar in si izberita predstavo, ki vaju zanima.", descriptionEn: "Check the schedule and pick a show that interests you both.", descriptionHr: "Provjerite repertoar i izaberite predstavu koja vas zanima.", category: "kulturno", cost: "eur2", duration: "2h+", locationType: "gledalisca", city: "Ljubljana" },
  { title: "Muzej iluzij", titleEn: "Museum of Illusions", titleHr: "Muzej iluzija", description: "Zabavna in fotogenična izkušnja za pare.", descriptionEn: "A fun, photogenic experience for couples.", descriptionHr: "Zabavno i fotogenično iskustvo za parove.", category: "kulturno", cost: "eur2", duration: "1h", locationType: "muzeji", city: "Ljubljana", address: "Kongresni trg 3", lat: 46.0494, lng: 14.5044 },
  { title: "Obisk mestne knjižnice", titleEn: "Visit the city library", titleHr: "Posjet gradskoj knjižnici", description: "Poiščita si knjigo, ki jo bosta prebrala vsak zase ali skupaj na glas.", descriptionEn: "Find a book to read separately, or out loud together.", descriptionHr: "Pronađite knjigu koju ćete čitati svako za sebe ili naglas zajedno.", category: "kulturno", cost: "brezplacno", duration: "1h", locationType: "knjiznice", city: "Ljubljana" },
  { title: "Ogled Ljubljanskega gradu", titleEn: "Visit Ljubljana Castle", titleHr: "Razgled Ljubljanskog grada", description: "Sprehod do gradu z razgledom na celotno mesto.", descriptionEn: "Walk up to the castle for a view over the whole city.", descriptionHr: "Šetnja do dvorca s pogledom na cijeli grad.", category: "kulturno", cost: "eur2", duration: "2h", locationType: "muzeji", city: "Ljubljana", lat: 46.0489, lng: 14.5083 },
  // Aktivno
  { title: "Plezanje", titleEn: "Climbing", titleHr: "Penjanje", description: "Preizkusita se v športnem plezanju v plezalnem centru.", descriptionEn: "Try sport climbing at a climbing gym.", descriptionHr: "Okušajte se u sportskom penjanju u penjačkom centru.", category: "aktivno", cost: "eur2", duration: "2h", locationType: "rekreacijski-centri", city: "Ljubljana" },
  { title: "Kegljanje", titleEn: "Bowling", titleHr: "Kuglanje", description: "Zabavno tekmovanje med partnerjema.", descriptionEn: "A fun competition between the two of you.", descriptionHr: "Zabavno natjecanje između partnera.", category: "aktivno", cost: "eur2", duration: "1h", locationType: "rekreacijski-centri", city: "Ljubljana" },
  { title: "Drsanje", titleEn: "Ice skating", titleHr: "Klizanje", description: "Zimska aktivnost na ljubljanskem drsališču.", descriptionEn: "A winter activity at Ljubljana's ice rink.", descriptionHr: "Zimska aktivnost na ljubljanskom klizalištu.", category: "aktivno", cost: "eur", duration: "1h", locationType: "rekreacijski-centri", city: "Ljubljana" },
  { title: "Mini golf", titleEn: "Mini golf", titleHr: "Mini golf", description: "Sproščena in zabavna igra na prostem.", descriptionEn: "A relaxed, fun outdoor game.", descriptionHr: "Opuštena i zabavna igra na otvorenom.", category: "aktivno", cost: "eur", duration: "1h", locationType: "rekreacijski-centri", city: "Ljubljana" },
  { title: "Tekaška tura", titleEn: "Running route", titleHr: "Trkačka tura", description: "Skupaj preteczita svojo najljubšo traso.", descriptionEn: "Run your favorite route together.", descriptionHr: "Zajedno pretrčite svoju najdražu rutu.", category: "aktivno", cost: "brezplacno", duration: "1h" },
  // Sproscceno
  { title: "Kava v centru", titleEn: "Coffee downtown", titleHr: "Kava u centru", description: "Poiščita novo kavarno in poskusita njihovo posebno ponudbo.", descriptionEn: "Find a new café and try their specialty.", descriptionHr: "Pronađite novi kafić i probajte njihovu posebnu ponudu.", category: "sprosceno", cost: "eur", duration: "30min", locationType: "kavarne", city: "Ljubljana", lat: 46.0511, lng: 14.5061 },
  { title: "Nakupovanje", titleEn: "Shopping", titleHr: "Shopping", description: "Sproščen dan brskanja po trgovinah brez pritiska po nakupu.", descriptionEn: "A relaxed day browsing shops with no pressure to buy.", descriptionHr: "Opušten dan pregledavanja trgovina bez pritiska za kupnju.", category: "sprosceno", cost: "eur2", duration: "2h", locationType: "trgovine", city: "Ljubljana" },
  { title: "Sladoled v mestu", titleEn: "Ice cream in town", titleHr: "Sladoled u gradu", description: "Poiščita najboljšo sladoledarno v okolici.", descriptionEn: "Find the best ice cream shop in the area.", descriptionHr: "Pronađite najbolju slastičarnicu u okolici.", category: "sprosceno", cost: "eur", duration: "30min", locationType: "kavarne", city: "Ljubljana" },
  { title: "Obisk živalskega vrta", titleEn: "Visit the zoo", titleHr: "Posjet zoološkom vrtu", description: "Sproščen družinski dan v ljubljanskem živalskem vrtu.", descriptionEn: "A relaxed day out at the Ljubljana Zoo.", descriptionHr: "Opušten obiteljski dan u ljubljanskom zoološkom vrtu.", category: "sprosceno", cost: "eur2", duration: "2h+", locationType: "parki", city: "Ljubljana", address: "Večna pot 70", lat: 46.0447, lng: 14.4681 },
  { title: "Branje v parku", titleEn: "Reading in the park", titleHr: "Čitanje u parku", description: "Vzemita knjigo in poiščita mirno klopco v parku.", descriptionEn: "Bring a book and find a quiet bench in the park.", descriptionHr: "Ponesite knjigu i pronađite mirnu klupu u parku.", category: "sprosceno", cost: "brezplacno", duration: "1h", locationType: "parki", city: "Ljubljana" },
  // €€€
  { title: "Večerja v vrhunski restavraciji", titleEn: "Dinner at a top restaurant", titleHr: "Večera u vrhunskom restoranu", description: "Razvajajta se z izbranim menijem v eni izmed najboljših restavracij v mestu.", descriptionEn: "Treat yourselves to a set menu at one of the city's best restaurants.", descriptionHr: "Razmazite se odabranim menijem u jednom od najboljih restorana u gradu.", category: "sprosceno", cost: "eur3", duration: "2h", locationType: "restavracije", city: "Ljubljana" },
  { title: "Spa vikend za dva", titleEn: "Spa weekend for two", titleHr: "Spa vikend za dvoje", description: "Pobegnita od vsakdana s celodnevnim wellness razvajanjem in savnami.", descriptionEn: "Escape the everyday with a full day of wellness pampering and saunas.", descriptionHr: "Pobjegnite od svakodnevice uz cjelodnevno wellness razmaženje i saune.", category: "sprosceno", cost: "eur3", duration: "2h+", locationType: "rekreacijski-centri", city: "Ljubljana" },
  { title: "Let z balonom nad Ljubljano", titleEn: "Hot air balloon ride over Ljubljana", titleHr: "Let balonom iznad Ljubljane", description: "Doživita mesto z drugačne perspektive na nepozabnem poletu z balonom.", descriptionEn: "See the city from a whole new perspective on an unforgettable balloon flight.", descriptionHr: "Doživite grad iz druge perspektive na nezaboravnom letu balonom.", category: "aktivno", cost: "eur3", duration: "2h+", city: "Ljubljana" },
  { title: "Degustacija vin v vinski kleti", titleEn: "Wine tasting at a cellar", titleHr: "Degustacija vina u vinskom podrumu", description: "Odkrijta okuse slovenskih vin ob vodenem pokušanju z lokalnim sommelierjem.", descriptionEn: "Discover Slovenian wines with a guided tasting led by a local sommelier.", descriptionHr: "Otkrijte okuse slovenskih vina uz vođenu degustaciju s lokalnim sommelierom.", category: "kulturno", cost: "eur3", duration: "2h", locationType: "vinarije", city: "Ljubljana" },
  { title: "Zasebna kuharska delavnica", titleEn: "Private cooking class", titleHr: "Privatna kuharska radionica", description: "Pod vodstvom kuharja skupaj pripravita večerni meni po meri.", descriptionEn: "Prepare a custom dinner menu together, guided by a chef.", descriptionHr: "Pod vodstvom kuhara zajedno pripremite večernji meni po mjeri.", category: "aktivno", cost: "eur3", duration: "2h", city: "Ljubljana" },
  ...
  { title: "Piknik na balkonu ali terasi", titleEn: "Picnic on the balcony or terrace", titleHr: "Piknik na balkonu ili terasi", description: "Postelita odejo, pripravita prigrizke in uživajta v večeru na svežem zraku doma.", descriptionEn: "Lay out a blanket, prepare some snacks, and enjoy an evening outdoors at home.", descriptionHr: "Prostrite deku, pripremite grickalice i uživajte u večeri na svježem zraku kod kuće.", category: "doma", cost: "brezplacno", duration: "1h" },
  { title: "Skupno pisanje zgodbe", titleEn: "Write a story together", titleHr: "Zajedničko pisanje priče", description: "Vsak izmenoma napiše en stavek in skupaj ustvarita smešno ali romantično zgodbo.", descriptionEn: "Take turns writing one sentence at a time to create a funny or romantic story.", descriptionHr: "Naizmjenično napišite po jednu rečenicu i zajedno stvorite smiješnu ili romantičnu priču.", category: "doma", cost: "brezplacno", duration: "30min" },
  { title: "Degustacija doma", titleEn: "Tasting at home", titleHr: "Degustacija kod kuće", description: "Pripravita majhno degustacijo sirov, čokolad ali vin, ki jih še nista poskusila.", descriptionEn: "Put together a small tasting of cheeses, chocolates, or wines you haven't tried yet.", descriptionHr: "Pripremite malu degustaciju sireva, čokolada ili vina koje još niste probali.", category: "doma", cost: "eur", duration: "1h" },
  { title: "Karaoke večer", titleEn: "Karaoke night", titleHr: "Karaoke večer", description: "Izberita najljubše pesmi in zapojta na glas, kot da vaju nihče ne posluša.", descriptionEn: "Pick your favorite songs and sing out loud like nobody's listening.", descriptionHr: "Izaberite najdraže pjesme i pjevajte naglas kao da vas nitko ne sluša.", category: "doma", cost: "brezplacno", duration: "1h" },
  { title: "Sprehod v bližnjem parku", titleEn: "Walk in a nearby park", titleHr: "Šetnja u obližnjem parku", description: "Poiščita najbližji park ali zeleno površino in se sprostita ob sprehodu.", descriptionEn: "Find the nearest park or green space and unwind with a walk.", descriptionHr: "Pronađite najbliži park ili zelenu površinu i opustite se uz šetnju.", category: "na-prostem", cost: "brezplacno", duration: "1h" },
  { title: "Kolesarjenje po okolici", titleEn: "Cycling in the area", titleHr: "Biciklizam u okolici", description: "Odkrijta nove kolesarske poti v svoji okolici.", descriptionEn: "Discover new bike routes near you.", descriptionHr: "Otkrijte nove biciklističke staze u svojoj okolici.", category: "na-prostem", cost: "brezplacno", duration: "2h" },
  { title: "Opazovanje zvezd", titleEn: "Stargazing", titleHr: "Promatranje zvijezda", description: "Poiščita temno mesto stran od mestnih luči in opazujta nočno nebo.", descriptionEn: "Find a dark spot away from city lights and watch the night sky.", descriptionHr: "Pronađite tamno mjesto podalje od gradskih svjetala i promatrajte noćno nebo.", category: "na-prostem", cost: "brezplacno", duration: "1h" },
  { title: "Piknik v naravi", titleEn: "Picnic in nature", titleHr: "Piknik u prirodi", description: "Vzemita odejo in malico ter poiščita lepo mesto v naravi za piknik.", descriptionEn: "Bring a blanket and snacks and find a nice spot in nature for a picnic.", descriptionHr: "Ponesite deku i užinu te pronađite lijepo mjesto u prirodi za piknik.", category: "na-prostem", cost: "eur", duration: "2h+" },
  { title: "Tek ali hitra hoja skupaj", titleEn: "Run or brisk walk together", titleHr: "Trčanje ili brza hodnja zajedno", description: "Preteczita ali prehoditva svojo najljubšo traso v okolici.", descriptionEn: "Run or walk your favorite route in the area.", descriptionHr: "Pretrčite ili prehodajte svoju najdražu rutu u okolici.", category: "aktivno", cost: "brezplacno", duration: "1h" },
  { title: "Joga v dvoje", titleEn: "Couples yoga", titleHr: "Joga u dvoje", description: "Poiščita spletno vadbo joge za pare in jo skupaj preizkusita.", descriptionEn: "Find an online couples yoga workout and try it together.", descriptionHr: "Pronađite online vježbu joge za parove i zajedno je isprobajte.", category: "aktivno", cost: "brezplacno", duration: "1h" },
  { title: "Obisk bližnjega plezalnega centra", titleEn: "Visit a nearby climbing gym", titleHr: "Posjet obližnjem penjačkom centru", description: "Preizkusita se v športnem plezanju v najbližjem plezalnem centru.", descriptionEn: "Try sport climbing at the nearest climbing gym.", descriptionHr: "Okušajte se u sportskom penjanju u najbližem penjačkom centru.", category: "aktivno", cost: "eur2", duration: "2h" },
  { title: "Kolesarski izlet", titleEn: "Bike trip", titleHr: "Biciklistički izlet", description: "Odpravita se na daljši kolesarski izlet v okolico.", descriptionEn: "Head out on a longer bike ride around the area.", descriptionHr: "Krenite na duži biciklistički izlet u okolicu.", category: "aktivno", cost: "brezplacno", duration: "2h+" },
  { title: "Kava v novi kavarni", titleEn: "Coffee at a new café", titleHr: "Kava u novom kafiću", description: "Poiščita kavarno v svoji bližini, ki je še nista obiskala.", descriptionEn: "Find a café near you that you haven't visited yet.", descriptionHr: "Pronađite kafić u svojoj blizini koji još niste posjetili.", category: "sprosceno", cost: "eur", duration: "30min" },
  { title: "Nakupovalni popoldan", titleEn: "Shopping afternoon", titleHr: "Popodne u kupnji", description: "Sproščen dan brskanja po trgovinah v svojem mestu, brez pritiska po nakupu.", descriptionEn: "A relaxed day browsing shops in your own town, no pressure to buy.", descriptionHr: "Opušten dan pregledavanja trgovina u svom gradu, bez pritiska za kupnju.", category: "sprosceno", cost: "eur2", duration: "2h" },
  { title: "Sladoled v bližini", titleEn: "Ice cream nearby", titleHr: "Sladoled u blizini", description: "Poiščita najboljšo sladoledarno v svoji okolici.", descriptionEn: "Find the best ice cream shop in your area.", descriptionHr: "Pronađite najbolju slastičarnicu u svojoj okolici.", category: "sprosceno", cost: "eur", duration: "30min" },
  { title: "Obisk lokalnega muzeja ali galerije", titleEn: "Visit a local museum or gallery", titleHr: "Posjet lokalnom muzeju ili galeriji", description: "Preverita, kateri muzej ali galerija je v vajini bližini, in jo obiščita skupaj.", descriptionEn: "Check what museum or gallery is near you and visit it together.", descriptionHr: "Provjerite koji je muzej ili galerija u vašoj blizini i posjetite ga zajedno.", category: "kulturno", cost: "eur", duration: "2h" },
  { title: "Ogled predstave v lokalnem gledališču", titleEn: "See a show at a local theatre", titleHr: "Odlazak na predstavu u lokalno kazalište", description: "Preverita repertoar najbližjega gledališča in si izberita predstavo.", descriptionEn: "Check the schedule of the nearest theatre and pick a show.", descriptionHr: "Provjerite repertoar najbližeg kazališta i izaberite predstavu.", category: "kulturno", cost: "eur2", duration: "2h+" },
  { title: "Obisk lokalne knjižnice", titleEn: "Visit your local library", titleHr: "Posjet lokalnoj knjižnici", description: "Poiščita si knjigo v svoji mestni knjižnici, ki jo bosta prebrala vsak zase ali na glas.", descriptionEn: "Find a book at your local library to read separately or out loud together.", descriptionHr: "Pronađite knjigu u svojoj gradskoj knjižnici koju ćete čitati svako za sebe ili naglas.", category: "kulturno", cost: "brezplacno", duration: "1h" },
  ...
  // v skladu z zahtevo po razpoznavnem, a nevpadljivem oglaševanju.
  {
    ...
    titleEn: "Temptico chocolate for two",
    titleHr: "Temptico čokolada za dvoje",
    ...
    descriptionEn: "Surprise each other with sensual Temptico chocolate made for couples and enjoy a special evening. Use code TOGETHER10 for 10% off.",
    descriptionHr: "Iznenadite jedno drugo osjetilnom Temptico čokoladom za parove i uživajte u posebnoj večeri. Iskoristite kod TOGETHER10 za 10% popusta.",
    category: "sprosceno",
    cost: "eur2",
    duration: "1h",
...
export async function runSeed() {
  ...
  for (const idea of DATE_IDEAS) {
    const existing = existingIdeasByTitle.get(idea.title) as typeof dateIdeas.$inferSelect | undefined;
    if (existing && (!existing.titleEn || !existing.titleHr || !existing.descriptionEn || !existing.descriptionHr)) {
      await db
        .update(dateIdeas)
        .set({ titleEn: idea.titleEn, titleHr: idea.titleHr, descriptionEn: idea.descriptionEn, descriptionHr: idea.descriptionHr })
        .where(eq(dateIdeas.id, existing.id));
    }
  }
